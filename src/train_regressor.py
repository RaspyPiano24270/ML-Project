...
from tensorflow.keras.models import Sequential  # <--- Was missing in your snippet
from tensorflow.keras.layers import LSTM, Dense, Dropout
from tensorflow.keras.optimizers import Adam
from tensorflow.keras.callbacks import EarlyStopping
from sklearn.preprocessing import MinMaxScaler
# We use the helper functions we just built
...
# 1. Load Data (Automatic Path Handling)
# No need to pass a file path anymore!
...
# 3. Create Sequences (One line replacement)
# We removed the manual 'def create_sequences...' block here
...
# Layer 1: Captures time patterns
model.add(LSTM(128, return_sequences=True, input_shape=(X_train.shape[1], X_train.shape[2])))
model.add(Dropout(0.2))

# Layer 2: Condenses info
